...
function CreateOrder() {
  ...
  return (
    <div className="px-4 py-6 ">
      <h2 className="mb-8 text-xl font-semibold ">Indulge in the Ultimate Burger Experience: Juicy, Flavorful, and Grilled to Perfection – Satisfy Your Cravings Now!</h2>
      ...
      <Form method="POST">
        ...
        <div className="relative flex flex-col gap-2 mb-5 sm:flex-row sm:items-center">
          ...
          {!position.latitude && !position.longitude && (
            <span className="absolute right-[3px] top-[34px] z-50 sm:right-[5px] sm:top-[5px]">
              <Button
                disabled={isLoadingAddress}
                type="small"
                onClick={(e) => {
